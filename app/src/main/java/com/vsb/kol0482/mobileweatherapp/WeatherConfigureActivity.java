...
public class WeatherConfigureActivity extends Activity {
    ...
    View.OnClickListener mOnClickListener = new View.OnClickListener() {
        public void onClick(View v) {
            final Context context = WeatherConfigureActivity.this;
            ...
            Weather.updateAppWidget(context, appWidgetManager, mAppWidgetId);
    ...
    private WeatherConfigureBinding binding;

    public WeatherConfigureActivity() {
        super();
    }
    ...
    public void onCreate(Bundle icicle) {
        ...
        binding = WeatherConfigureBinding.inflate(getLayoutInflater());
        ...
        mAppWidgetText.setText(loadTitlePref(WeatherConfigureActivity.this, mAppWidgetId));
    }
}